...
pub fn save_credentials_to_localstorage(vdom_weak: dodrio::VdomWeak){
    ...
    let input_html_element_api_owner = unwrap!(input_api_owner.dyn_into::<web_sys::HtmlInputElement>(),"dyn_into");
    log1("before value()");
    ...
    log1("before dyn_into");
    let input_html_element_api_uid = unwrap!(input_api_uid.dyn_into::<web_sys::HtmlInputElement>(),"dyn_into");
    log1("before value()");
    ...
    log1("before dyn_into");
    let input_html_element_api_key = unwrap!(input_api_key.dyn_into::<web_sys::HtmlInputElement>(),"dyn_into");
    log1("before value()");
